# EMBOPSA_V0003B
# Standalone La2010a Earth-orbit animation, zoomed out 20% from V0003A.
...
TEMP_AVI = OUT_DIR / "EMBOPSA_TEMP_FULL_FRAME_ZOOM_OUT_20PCT.avi"
OUT_MP4 = OUT_DIR / "EMBOPSA_EARTH_ORBIT_FULL_FRAME_ZOOM_OUT_20PCT_H264.mp4"
...
try:
    for j in range(N_FRAMES):
        ...
        # 25% wider coordinate span makes the rendered orbit exactly 20% smaller.
